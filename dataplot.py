...
for this_sat in satlist:
    ...
    titletext = 'Raw CH2 data for svn%s' % (this_sat)
    ...
    #%%
    ax5 = plt.subplot(gs1[4,:-3],sharex=ax4)
    for i in range(int(pcr.shape[1])):
        curlabel = 'Proton Channel %s' % (i)
    ...
    #%%
    stemp = localpath + 'ns' + str(this_sat) + 'ch2plot' + str(start_date.year) + '_' + str(start_date.month) + '_' + str(start_date.day) + '___' + str(end_date.year) + '_' + str(end_date.month) + '_' + str(end_date.day) + '.png'
