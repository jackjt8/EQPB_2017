...
class gps_satellite_data_local():
    ...
    def __init__ (self,satellite_number,start_date,end_date,localpath):                  
        ...
        for f in self.filenames:
            ...
            i += 1
            print '\r' + str(i) + '/' + str(total) + ' - ' + str(round(time.clock() - start_time,3)),
...
class data_int():
    def __init__(self, localpath, satlist):
        ...
        #int folders
        self.createfolders(localpath + localfolder + rawf)
        self.createfolders(localpath + localfolder + prof)
        self.createfolders(localpath + localfolder + jsonf)
        for this_sat in satlist:
            self.createfolders(localpath + localfolder + rawf + 'ns' + str(this_sat) + '\\')
            self.createfolders(localpath + localfolder + prof + 'ns' + str(this_sat) + '\\')
            self.createfolders(localpath + localfolder + jsonf + 'ns' + str(this_sat) + '\\')
